...
class EditInVoiceDtlsComponent extends Component {
	 constructor(props) {
	 	super(props);
	  ...
	  editUsr = (e) =>  
	 {
      ...
      this.setState({"showModal":true,"compType":"I","mainHead":"Success","msgContent":"Invoice details updated successfully."});
	 }
    backClicked = (e) =>
    {
      e.preventDefault();
    ...
    prepareState = () => {
      var lobj = {};
      lobj.heading = "Edit Invoice";
      lobj.bankName= "HDFC Bank";
      lobj.bankIFSC="HDFC00984";
      lobj.accountNum="501412877014";
      ...
      lobj.country="India";
      lobj.branch="Whitefield Bangalore";
            ...
            <div className="ui form">
               <div className="fields">
                  <div className="field">
                     ...
                     <input type="text" placeholder="Bank Name" value={this.state.editUsrDtls.bankName} onChange={e => this.onTodoChange(e.target.value,"bankName")}/>
                  </div>
                  <div className="field">
                     <label>Bank IFSC</label>
                     <input type="text" placeholder="IFSC Code" onChange={e => this.onTodoChange(e.target.value,"bankIFSC")} value={this.state.editUsrDtls.bankIFSC}/>
                  </div>
                  <div className="field">
                     <label>Account Number</label>
                     <input onChange={e => this.onTodoChange(e.target.value,"accountNum")} value={this.state.editUsrDtls.accountNum}/>
                  </div>
                  <div className="field">
                     <label>Address</label>
               ...
               <div className="fields">
                  <div className="field">
                     <label>Branch</label>
                     <input type="text" placeholder="Branch" value={this.state.editUsrDtls.branch} onChange={e => this.onTodoChange(e.target.value,"branch")}/>
                  </div>
                  <div className="field">
                     <label>Website</label>
   ...
   EditInVoiceDtlsComponent.contextType = Context;
	export default EditInVoiceDtlsComponent
